...
void MInstall::progressUpdate(int value) noexcept
{
    ...
    case 0:
        gui.textTips->setText(tr("<p><b>If something happened...</b></p>"
                             ...
                             "<p>There is also a special section for old Linux applications, it is organized according to XDG specifications.</p>").arg(PROJECTNAME));
        break;
    ...
    case 3:
        gui.textTips->setText(tr("<p><b>Applications</b></p>"
                             "<p>The %1 has pre-installed applications, such as the Krita graphic editor, Audacity audio editor, OBS Studio for recording and streaming, and others.</p>").arg(PROJECTNAME));
        break;
